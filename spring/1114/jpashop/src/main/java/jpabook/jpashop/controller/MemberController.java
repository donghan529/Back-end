...
public class MemberController {
    ...
    public String create(@Valid @ModelAttribute("memberForm") MemberForm form, BindingResult result) { //@ModelAttribute("memberForm") 생략 가능
        if(result.hasErrors()) {
            return "members/createMemberForm";
        }
...
//앞서만들었던 'Address' 객체를 회원의 주소 정보로 설정 memberService.join(member)를 통해 회원 객체를 회원 가입
